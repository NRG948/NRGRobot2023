...
public class BrownPulse extends CommandBase {
  private final AdressableLEDSubsystem led;
  /** Creates a new BluePulse. */
  public BrownPulse(AdressableLEDSubsystem led) {
  ...
  public void execute() {
    for (int i = 0; i < RobotConstants.LED_COUNT; i++) {
      Color8Bit color = new Color8Bit(Color.kBrown);
