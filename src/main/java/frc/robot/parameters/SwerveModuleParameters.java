...
public enum SwerveModuleParameters {
  ...
  MK4Standard(Units.inchesToMeters(3.6875), 8.14, 12.8),

  /** An MK4 Swerve Module in the L2 - Fast configuration. */
  MK4Fast(Units.inchesToMeters(3.6875), 6.75, 12.8),

  /** An MK4 Swerve Module in the L3 - Very Fast configuration. */
  MK4VeryFast(Units.inchesToMeters(3.6875), 6.12, 12.8),

  /** An MK4 Swerve Module in the L4 - Too Fast configuration. */
  MK4TooFast(Units.inchesToMeters(3.6875), 5.14, 12.8);
